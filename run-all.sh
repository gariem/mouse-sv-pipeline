...
do
    ...
    nextflow run taks/merge_survivor_mapped.nf --strain $STRAIN --max_dist 50 --min_callers 1 --min_size 20 --filter_hets 0
    nextflow run taks/merge_survivor_mapped.nf --strain $STRAIN --max_dist 100 --min_callers 1 --min_size 20 --filter_hets 0
    nextflow run taks/merge_survivor_mapped.nf --strain $STRAIN --max_dist 50 --min_callers 1 --min_size 20 --filter_hets 1
    nextflow run taks/merge_survivor_mapped.nf --strain $STRAIN --max_dist 100 --min_callers 1 --min_size 20 --filter_hets 1

    nextflow run taks/merge_combi.nf --strain $STRAIN --min_coverage 3
    nextflow run taks/merge_combi.nf --strain $STRAIN --min_coverage 5
    nextflow run taks/merge_combi.nf --strain $STRAIN --min_coverage 10
    ...
    nextflow run taks/metrics_collect.nf --intersect_window_a 20 --intersect_window_b 20 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c3.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 30 --intersect_window_b 30 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c3.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 50 --intersect_window_b 50 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c3.vcf

    nextflow run taks/metrics_collect.nf --intersect_window_a 20 --intersect_window_b 20 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c5.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 30 --intersect_window_b 30 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c5.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 50 --intersect_window_b 50 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c5.vcf

    nextflow run taks/metrics_collect.nf --intersect_window_a 20 --intersect_window_b 20 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c10.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 30 --intersect_window_b 30 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c10.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 50 --intersect_window_b 50 --filter_hets 0 --input_files ./data/input/$STRAIN-combisv_c10.vcf

    nextflow run taks/metrics_collect.nf --intersect_window_a 20 --intersect_window_b 20 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c3.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 30 --intersect_window_b 30 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c3.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 50 --intersect_window_b 50 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c3.vcf

    nextflow run taks/metrics_collect.nf --intersect_window_a 20 --intersect_window_b 20 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c5.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 30 --intersect_window_b 30 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c5.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 50 --intersect_window_b 50 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c5.vcf

    nextflow run taks/metrics_collect.nf --intersect_window_a 20 --intersect_window_b 20 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c10.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 30 --intersect_window_b 30 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c10.vcf
    nextflow run taks/metrics_collect.nf --intersect_window_a 50 --intersect_window_b 50 --filter_hets 1 --input_files ./data/input/$STRAIN-combisv_c10.vcf
